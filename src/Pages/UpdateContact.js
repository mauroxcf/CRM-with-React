...
//BL
import { formInitialValuesEdit, formValidationSchema } from '../Data/data';

/**
 * It's a function that returns a contact form to edit using formik library
	...
	return (
		<ViewTemplate>
			<div className='flex flex-col md:h-full w-full gap-4 pt-8 px-4 pb-4'>
				<p className='text-md text-blue-900 font-bold pl-8'>Editar contacto</p>
				<div className='flex flex-col gap-2  w-full  '>
					<Formik
						initialValues={formInitialValuesEdit}
